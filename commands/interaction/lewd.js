...
module.exports = class extends Command {
    ...
    if(miembro === message.author) return message.channel.send('Piensa en alguien más... unu')
    ...
    if(!miembro){
      message.channel.send({embed: 
        ...
        const msg = [`**${message.author.username}** piensa en cosas indecentes por **${miembro.username}**.`]
