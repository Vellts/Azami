...
const levels = require("./models/points.js");
var mongoUrl;
...
class DiscordPoints {
  ...
  */
  ...
  static async addPoints(userId, guildId, xp) {
    if (!userId) throw new TypeError("An user id was not provided.");
    if (!guildId) throw new TypeError("A guild id was not provided.");
  ...
  */
  ...
  static async setPoints(userId, guildId, xp) {
    if (!userId) throw new TypeError("An user id was not provided.");
    if (!guildId) throw new TypeError("A guild id was not provided.");
    if (xp == 0 || !xp || isNaN(parseInt(xp))) throw new TypeError("An amount of xp was not provided/was invalid.");
  ...
  */
  ...
  static async fetch(userId, guildId, fetchPosition = false) {
    ...
    user.cleanXp = user.xp - this.pointsFor(user.level);
    user.cleanNextLevelXp = this.pointsFor(user.level + 1) - this.pointsFor(user.level);
  ...
  */
  ...
  static async removePoints(userId, guildId, xp) {
    if (!userId) throw new TypeError("An user id was not provided.");
    if (!guildId) throw new TypeError("A guild id was not provided.");
    if (xp == 0 || !xp || isNaN(parseInt(xp))) throw new TypeError("An amount of xp was not provided/was invalid.");
